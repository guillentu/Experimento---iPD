function x = extraerDatos_iPD(str)
    clear x;
  str
  %-Varialbes--------------------------------
%sujetos
...
%  _fileStr=fgetl(_fid);         %lee lineas
  ...
  while (feof(_fid)==0)
    ...
    _sujeto=0; 
    if cargar==1
			if strcmp(_groupStr,"1A_403")
				_sujeto=1;
			elseif strcmp(_groupStr,"3A_403")
				_sujeto=3;
			elseif strcmp(_groupStr,"1B_403")
				_sujeto=5;
		  elseif strcmp(_groupStr,"2A_404")
				_sujeto=2;
		  elseif strcmp(_groupStr,"4A_404")
				_sujeto=4;
			elseif strcmp(_groupStr,"2B_404")
				_sujeto=6;
			endif
